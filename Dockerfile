...
RUN emerge -v dev-libs/json-glib x11-libs/libva app-text/yelp-tools media-sound/pulseaudio x11-libs/libxkbcommon gnome-base/nautilus gnome-extra/nemo xfce-base/thunar
