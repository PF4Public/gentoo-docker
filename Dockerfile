...
RUN echo -e "app-text/poppler -qt5\ngnome-base/nautilus -previewer\nmedia-video/ffmpeg -svg" > /etc/portage/package.use/custom
...
RUN emerge -v --unmerge net-misc/openssh sys-apps/sandbox virtual/jpeg media-libs/jpeg
...
RUN emerge -v media-libs/libjpeg-turbo app-text/yelp-tools media-sound/pulseaudio x11-libs/libxkbcommon gnome-base/nautilus xfce-base/thunar dev-libs/wayland
