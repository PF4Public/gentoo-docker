...
RUN emerge -v --getbinpkgonly=y --binpkg-respect-use=n x11-libs/gtk+; exit 0
RUN emerge -v --getbinpkgonly=y --binpkg-respect-use=n dev-util/gtk-doc net-libs/webkit-gtk media-libs/openh264 dev-libs/re2 media-libs/libvpx media-libs/libsdl media-libs/libsdl2 media-sound/mpg123 media-sound/mpg123 media-sound/deadbeef media-video/ffmpeg sys-devel/clang sys-devel/llvm

RUN USE=pulseaudio emerge -v app-text/yelp-tools media-libs/libjpeg-turbo
